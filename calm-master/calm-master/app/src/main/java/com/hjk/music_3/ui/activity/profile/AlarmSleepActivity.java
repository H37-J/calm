...
public class AlarmSleepActivity extends AppCompatActivity {
    ...
    public void Intent_Alarm(){
        ...
        timePickerDialog=new TimePickerDialog(AlarmSleepActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void Set_Alarm(){
        ...
        pendingIntent= PendingIntent.getBroadcast(AlarmSleepActivity.this,0,alarm_intent,
