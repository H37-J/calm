...
public class PlayerActivityLike extends AppCompatActivity {

    PlayerLikeBinding binding;
    ...
    public void onCreate(Bundle save){
        super.onCreate(save);
        binding= DataBindingUtil.setContentView(this, R.layout.player_like);
    ...
    public void onResume(){
        ...
        binding.background.setOnTouchListener(new OnSwipeTouchListener(PlayerActivityLike.this) {
...
//                binding.musicTime.setText(string);
    ...
    public void exit(){
        Intent intent=new Intent(PlayerActivityLike.this,MusicExit.class);
    ...
    public void share() {
        Picasso.get().load(
                musicViewModel.getCurrent_like_music().getValue().getImage()).into(new Target() {
            @Override
