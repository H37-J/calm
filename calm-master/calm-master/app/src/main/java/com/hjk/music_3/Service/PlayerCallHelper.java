...
import com.hjk.music_3.Receiver.PlayerReceiver;
...
public class PlayerCallHelper implements AudioManager.OnAudioFocusChangeListener {
    ...
    public PlayerCallHelper(PlayerCallHelperListener playerCallHelperListener) { mPlayerCallHelperListener = playerCallHelperListener; }
